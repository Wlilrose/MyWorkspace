        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @can('website_management_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/websites*") ? "menu-open" : "" }} {{ request()->is("admin/technology-useds*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle" href="#">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @endcan
                            @can('technology_used_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.technology-useds.index") }}" class="nav-link {{ request()->is("admin/technology-useds") || request()->is("admin/technology-useds/*") ? "active" : "" }}">
                                        <i class="fa-fw nav-icon fas fa-cogs">

                                        </i>
                                        <p>
                                            {{ trans('cruds.technologyUsed.title') }}
                                        </p>
                                    </a>
                                </li>
                            @endcan
                ...
                @can('server_management_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/database-servers*") ? "menu-open" : "" }} {{ request()->is("admin/web-servers*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle" href="#">
                        ...
                        <ul class="nav nav-treeview">
                            @can('database_server_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.database-servers.index") }}" class="nav-link {{ request()->is("admin/database-servers") || request()->is("admin/database-servers/*") ? "active" : "" }}">
                                        <i class="fa-fw nav-icon fas fa-database">

                                        </i>
                                        <p>
                                            {{ trans('cruds.databaseServer.title') }}
                                        </p>
                                    </a>
                                </li>
                            @endcan
                            @can('web_server_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.web-servers.index") }}" class="nav-link {{ request()->is("admin/web-servers") || request()->is("admin/web-servers/*") ? "active" : "" }}">
                                        <i class="fa-fw nav-icon fas fa-cogs">

                                        </i>
                                        <p>
                                            {{ trans('cruds.webServer.title') }}
                                        </p>
                                    </a>
                                </li>
                            @endcan
