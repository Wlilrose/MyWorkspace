    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.websites.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('web_url') ? 'is-invalid' : '' }}" type="text" name="web_url" id="web_url" value="{{ old('web_url', '') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status" id="status">{{ old('status') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_uploaded') ? 'is-invalid' : '' }}" type="text" name="date_uploaded" id="date_uploaded" value="{{ old('date_uploaded') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('hosting_server') ? 'is-invalid' : '' }}" name="hosting_server_id" id="hosting_server_id" required>
                    @foreach($hosting_servers as $id => $entry)
                        <option value="{{ $id }}" {{ old('hosting_server_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('config_file_location') ? 'is-invalid' : '' }}" name="config_file_location" id="config_file_location">{{ old('config_file_location') }}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('database_server') ? 'is-invalid' : '' }}" name="database_server_id" id="database_server_id" required>
                    @foreach($database_servers as $id => $entry)
                        <option value="{{ $id }}" {{ old('database_server_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('platform') ? 'is-invalid' : '' }}" name="platform_id" id="platform_id">
                    @foreach($platforms as $id => $entry)
                        <option value="{{ $id }}" {{ old('platform_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('web_version') ? 'is-invalid' : '' }}" type="text" name="web_version" id="web_version" value="{{ old('web_version', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('admin_url') ? 'is-invalid' : '' }}" type="text" name="admin_url" id="admin_url" value="{{ old('admin_url', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('admin_password') ? 'is-invalid' : '' }}" type="password" name="admin_password" id="admin_password" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('site_template') ? 'is-invalid' : '' }}" type="text" name="site_template" id="site_template" value="{{ old('site_template', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('favicon') ? 'is-invalid' : '' }}" type="text" name="favicon" id="favicon" value="{{ old('favicon', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_last_check') ? 'is-invalid' : '' }}" type="text" name="date_last_check" id="date_last_check" value="{{ old('date_last_check') }}">
