...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.databaseServer.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.database-servers.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('server_ip') ? 'is-invalid' : '' }}" type="text" name="server_ip" id="server_ip" value="{{ old('server_ip', '') }}" required>
